...
Usage:
    python execution/ad_creator/generate_ad_creatives.py --input execution/ad_creator/sample_variables.json --out .tmp/generated_ads/demo
    python execution/ad_creator/generate_ad_creatives.py --input .tmp/ad_batches/agencies.json --out .tmp/generated_ads/agencies --seed 42

    # Generate for a different product by pointing at its brand config
    # (defaults to execution/shared/brands/unified_dashboards.json if --brand is omitted):
    python execution/ad_creator/generate_ad_creatives.py --input .tmp/ad_batches/leadforge.json \\
        --out .tmp/generated_ads/leadforge --brand execution/shared/brands/leadforge.json

Brand config schema (JSON, see execution/shared/brands/*.json):
...
DEFAULT_BRAND = {
    ...
    "footer_html": (
        "<strong>Ad Creator</strong> — generated by execution/ad_creator/generate_ad_creatives.py. "
...
def main():
    ...
    parser.add_argument("--brand", default=None,
                         help="Path to a brand config JSON (see execution/shared/brands/). "
